...
ShadowUFLocals = setmetatable({
	...
	["Any bars that appear before or after the full size options will use the entire frames width.\n\nThe remaining bars that are between those two numbers are shown next to the portrait."] = "任何在全尺寸选项之前或之后出现的计量条将使用整体框体宽度。\n\n介于那2个数字的剩下的计量条将在肖像旁边显示。",
	...
	["Color code for the class, use [classcolor][class][close] if you want the class text to be colored by class"] = "按职业著色代码, 使用 [classcolor][class][close] 如果你想按职业著色职业文字",
	["Color health by"] = "著色血量按",
	["Color on aggro"] = "著色获得仇恨",
	...
	["Health bar color used as the transitional color for 100% -> 0% on players, as well as when your pet is mildly unhappy."] = "生命条颜色按从 100% -> 0% 的过渡来著色, 也可以作用于你的宠物欢乐度.",
	["Health bar color used as the transitional color for 100% -> 50% on players, as well as when your pet is happy."] = "生命条颜色按从 100% -> 50% 的过渡来著色, 也可以作用于你的宠物欢乐度.",
	["Health bar color used as the transitional color for 50% -> 0% on players, as well as when your pet is very unhappy."] = "生命条颜色按从 50% -> 00% 的过渡来著色, 也可以作用于你的宠物欢乐度.",
	...
	["If the unit is hostile, the reaction color will override any color health by options."] = "如果单位为敌对, 则感应颜色将覆盖在选项中设置的任意生命值颜色.",
	...
	["If you hide a frame, you will have to do a /console reloadui for them to show back up again."] = "如果你隐藏一个框体, 你将必须通过 /console reloadui 来重新显示他们.",
	["Import"] = "导入",
	...
	["Reaction color code, use [reactcolor][name][close] to color the units name by their reaction."] = "感应颜色代码, 使用 [reactcolor][name][close] 来按他们的反应类型著色头像名字.",
	...
	["Select a text widget from the left side panel to set tags, you can use this page to change the truncate width and sizing."] = "从左边的面板选择一个文本组件来设置标签, 你可以使用本页来修改缩短的宽度和大小.",
	...
	["Sets if unit tooltips should be hidden while in combat."] = "设置当在战斗状态中头像提示讯息是否隐藏.",
	...
	["Shows how long a unit has been AFK or DND."] = "显示AFK或者勿打扰状态的时间.",
	...
	["This will disable the units frame turning into their vehicle frame when they enter one."] = "这个将当进入一个载具时禁止头像框体转入到载具框体.",
	["This will enable fast updating of the health bar, giving you more slightly faster health bar information than you normally would get."] = "这个将启用生命条的快速刷新, 比普通方式更快的获得生命条讯息.",
	["This will enable fast updating of the power bar, giving you more slightly faster power information than you normally would get."] = "这个将启用能力条的快速刷新, 比普通方式更快的获得能力条讯息.",
	...
	["Unit name colored by class."] = "按职业著色单位名字",
	["Unit server"] = "单位所在服务器",
	...
	["You cannot drag child units, they have to be repositioned using the configuration for their unit in /shadowuf."] = "你不能拖动子单位, 他们可以在配置面板内设置位置.",
