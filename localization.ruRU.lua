...
ShadowUFLocals = setmetatable({
	...
	["Ignores the portrait and uses the entire frames width, the bar will be drawn either above or below the portrait depending on the order."] = "Игнорирование портрета и использование всей ширины рамки, полосы будут вытянуты либо вверх или вниз портрета в зависимости от установленного порядка.",
