...
local chiConfig = {max = 5, key = "chi", colorKey = "CHI", powerType = ShadowUF.is510 and SPELL_POWER_CHI or SPELL_POWER_LIGHT_FORCE, eventType = ShadowUF.is510 and "CHI" or "LIGHT_FORCE", icon = "Interface\\AddOns\\ShadowedUnitFrames\\media\\textures\\combo"}
