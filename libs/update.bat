...
svn export svn://svn.wowace.com/wow/libhealcomm-3-0/mainline/trunk --force LibHealComm-3.0 --depth=files
svn export svn://svn.wowace.com/wow/libsharedmedia-3-0/mainline/trunk/LibSharedMedia-3.0 --force LibSharedMedia-3.0
@PAUSE
