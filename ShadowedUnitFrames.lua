...
ShadowUF = {playerUnit = "player", raidUnits = {}, partyUnits = {}, modules = {}, moduleOrder = {}, units = {"player", "pet", "pettarget", "target", "targettarget", "targettargettarget", "focus", "focustarget", "party", "partypet", "partytarget", "raid", "maintank", "maintanktarget", "mainassist", "mainassisttarget"}}
ShadowUF.isBuild30300 = tonumber((select(2, GetBuildInfo()))) >= 10554
...
function ShadowUF:HideBlizzard(type)
	...
	elseif( type == "targettarget" and not ShadowUF.isBuild30300 ) then
...
-- I automatically generate my localization when pushing versions, this lets me not have to run the script everytime I do a localization change when working on things
if( UnitName("player") == "Mayen" and GetRealmName() == "Mal'Ganis" ) then
