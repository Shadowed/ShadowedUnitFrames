ShadowUFLocals = {
	...
	["M"] = "M",
	["Main assist frames"] = "Main assist frames",
	["Main assist member"] = "Main assist member",
	["Main tank frames"] = "Main tank frames",
	["Main tank member"] = "Main tank member",
	["Male"] = "Male",
	["Mana"] = "Mana",
	...
	["Showing the party in raid frames will use all raid frame configurations, party pets and party targets are automatically disabled as well."] = "Showing the party in raid frames will use all raid frame configurations, party pets and party targets are automatically disabled as well.",
	["Showing the player frame in party will use the party frame configuration."] = "Showing the player frame in party will use the party frame configuration.",
	...
	["headers"] = {
		["mainassist"] = "Main Assist #%d",
		["mainassisttarget"] = "Main Assist Target #%d",
		["maintank"] = "Main Tank #%d",
		["maintanktarget"] = "Main Tank Target #%d",
		["party"] = "Party #%d",
		["raid"] = "Raid #%d",
	},
	["indicatorDesc"] = {
