...
function ShadowUF:LoadDefaultLayout(useMerge)
	...
	config.units = {
		...
		player = {
			...
			soulShards = {anchorTo = "$parent", order = 60, anchorPoint = "BR", x = -3, y = 6, size = 14, spacing = -4, growth = "LEFT", isBar = true},
			holyPower = {anchorTo = "$parent", order = 60, anchorPoint = "BR", x = -3, y = 6, size = 14, spacing = -4, growth = "LEFT", isBar = true},
			auras = {
